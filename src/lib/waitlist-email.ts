...
const COPY: Record<AppLocale, WelcomeCopy> = {
  "es-AR": {
    ...
    title: "Listo.",
    body: "Cuando Lume esté listo, te escribimos. Ese es el único motivo de este correo.",
  ...
  en: {
    ...
    title: "You're in.",
    body: "When Lume is ready, we'll write. That is the only reason we have this address.",
